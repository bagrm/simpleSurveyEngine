...
// Parse functions
// These parse the questions to be created and ensure proper input
// They are split into two types, textbox, and questions with limitied answers (QAndA)
...
// Create functions
// These gather the necessary input for each question type to be added and send the
// data to the parse functions 
